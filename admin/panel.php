...
END;
        ...
        echo "<a href='rankingpanel.php?username=".''.$_SESSION["username"].''.'&pass='.hash("md5",$_SESSION["password"]).''."'>Rank Beatmaps</a><br/>";
        echo "<a href='banpanel.php?username=".''.$_SESSION["username"].''.'&pass='.hash("md5",$_SESSION["password"]).''."'>Ban Users</a><br/>";
        echo "<a href='staffadd.php?username=".''.$_SESSION["username"].''.'&pass='.hash("md5",$_SESSION["password"]).''."'>Add Staff</a><br/>";
        echo "<br><a href='recalc.php?username=".''.$_SESSION["username"].''.'&pass='.hash("md5",$_SESSION["password"]).''."'>Recalculate Scores for All Users</a><br/>";
    }
